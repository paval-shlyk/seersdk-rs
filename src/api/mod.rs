...
impl_api_request!(RobotInfoRequest, ApiRequest::State(StateApi::Info), res: StatusMessage);
impl_api_request!(RobotRunStatusRequest, ApiRequest::State(StateApi::Run), res: StatusMessage);
impl_api_request!(RobotLocationRequest, ApiRequest::State(StateApi::Loc), res: StatusMessage);
impl_api_request!(RobotSpeedRequest, ApiRequest::State(StateApi::Speed), res: StatusMessage);
impl_api_request!(RobotBlockStatusRequest, ApiRequest::State(StateApi::Block), res: StatusMessage);
impl_api_request!(RobotBatteryStatusRequest, ApiRequest::State(StateApi::Battery), res: StatusMessage);
...
// Misc API requests
impl_api_request!(SpeakerRequest, ApiRequest::Misc(MiscApi::PlayAudio), res: StatusMessage);
