...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    match client.request(CommonInfoRequest::new(), Duration::from_secs(5)).await {
        Ok(info) => {
    ...
    match client.request(BatteryStatusRequest::new(), Duration::from_secs(5)).await {
        Ok(battery) => {
            println!("│ ✓ Level:         {:<38.1}% │", battery.battery_level * 100.0);
    ...
    match client.request(RobotPoseRequest::new(), Duration::from_secs(5)).await {
        Ok(pose) => {
    ...
    match client.request(OperationInfoRequest::new(), Duration::from_secs(5)).await {
        Ok(info) => {
            println!("│ ✓ Mileage:       {:<38.2}m │", info.mileage);
            println!("│ ✓ Total Time:    {:<38.1}s │", info.total_time_ms / 1000.0);
    ...
    match client.request(BlockStatusRequest::new(), Duration::from_secs(5)).await {
        Ok(status) => {
    ...
    match client.request(MoveToTargetRequest::new(move_cmd), Duration::from_secs(5)).await {
        Ok(_) => println!("│ ✓ Navigation started to target: demo_target          │"),
    ...
    match client.request(NavStatusRequest::new(GetNavStatus::new()), Duration::from_secs(5)).await {
        Ok(nav) => {
            println!("│ ✓ Nav Status:    {:<38} │", format!("{:?}", nav.status));
    ...
    // Pause navigation
    match client.request(PauseTaskRequest::new(), Duration::from_secs(5)).await {
        Ok(_) => println!("│ ✓ Navigation paused                                  │"),
    ...
    // Resume navigation
    match client.request(ResumeTaskRequest::new(), Duration::from_secs(5)).await {
        Ok(_) => println!("│ ✓ Navigation resumed                                 │"),
    ...
    // Stop navigation
    match client.request(CancelTaskRequest::new(), Duration::from_secs(5)).await {
        Ok(_) => println!("│ ✓ Navigation canceled                                │"),
    ...
    match client.request(LoadJackRequest::new(), Duration::from_secs(5)).await {
        Ok(_) => println!("│ ✓ Jack load initiated                                │"),
    ...
    match client.request(SetJackHeightRequest::new(height_cmd), Duration::from_secs(5)).await {
        Ok(_) => println!("│ ✓ Jack height set to 0.3m                            │"),
        Err(e) => println!("│ ✗ Failed to set height: {:<25} │", e),
    }
    
    tokio::time::sleep(Duration::from_millis(500)).await;
    
    match client.request(UnloadJackRequest::new(), Duration::from_secs(5)).await {
        Ok(_) => println!("│ ✓ Jack unload initiated                              │"),
    ...
    match client.request(RelocateRequest::new(), Duration::from_secs(5)).await {
        Ok(_) => println!("│ ✓ Relocation initiated                               │"),
        Err(e) => println!("│ ✗ Failed: {:<43} │", e),
    }
    
    tokio::time::sleep(Duration::from_millis(500)).await;
    
    match client.request(ConfirmLocationRequest::new(), Duration::from_secs(5)).await {
        Ok(_) => println!("│ ✓ Location confirmed                                 │"),
        Err(e) => println!("│ ✗ Failed: {:<43} │", e),
    }
